                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="button-items"><a class="btn btn-primary waves-effect waves-light" href="#" role="button">Link</a>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="button-items">
                                        <button type="button" class="btn btn-success waves-effect waves-light" data-toggle="button" aria-pressed="false">Single toggle</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                        <label class="btn btn-secondary active">
                                            <input type="checkbox" checked="checked"> Checked-1</label>
                                        <label class="btn btn-secondary active">
                                            <input type="checkbox" checked="checked"> Checked-2</label>
                                        <label class="btn btn-secondary">
                                            <input type="checkbox"> Checked-3</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted m-b-30 font-14">Combine sets of button groups into button toolbars for more complex components. Use utility classes as needed to space out groups, buttons, and more.</p>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted m-b-30 font-14">Instead of applying button sizing classes to every button in a group, just add <code class="highlighter-rouge">.btn-group-*</code> to each <code class="highlighter-rouge">.btn-group</code>, including each one when nesting multiple groups.</p>
