                                ...
                                <div class="card-body">
                                 ...
                                 <?= $this->Form->create('',['id'=>'title_form','enctype'=>'multipart/form-data']) ?>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="email" id="email" value="<?php if(!empty($admin->email))
                                            { echo $admin->email; } ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="password" name="repassword"  id="re_password" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
