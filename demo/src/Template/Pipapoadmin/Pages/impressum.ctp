                            ...
                            <div class="card">
                                <div class="card-body">
                                 ...
                                 <div class="form-group row">
                                    <label for="facebook" class="col-sm-2 col-form-label">Copyrights </label>
                                    <div class="col-sm-10">
                                    <textarea class="summernote" name="content"><?php 
                                    if(!empty($impressum)){ echo $impressum->content; } ?></textarea>
                                </div>
                                 </div>
                                 <!-- <div class="form-group row">
                                    <label for="facebook" class="col-sm-2 col-form-label">Main Content</label>
                                    <div class="col-sm-10">
                                    <textarea class="summernote" name="content2"><?php 
                                    if(!empty($copyrights)){ echo $copyrights->content; } ?></textarea>
                                </div>
                                 </div> -->
                                    <!-- <div class="form-group row">
