                        ...
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <h4 class="page-title mb-0">Datenschutz</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                 ...
                                 <div class="form-group row">
                                    <label for="facebook" class="col-sm-2 col-form-label">datenschutz </label>
                                    <div class="col-sm-10">
                                    <textarea class="summernote" name="content"><?php 
                                    if(!empty($datenschutz)){ echo $datenschutz->content; } ?></textarea>
                                </div>
                            </div>
                                <div class="form-group row">
                                     <div class="col-sm-12">
