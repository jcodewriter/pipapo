                            ...
                            <div class="card mini-stats">
                                <div class="p-3 mini-stats-content">
                                    <div class="mb-4">
                                        ...
                                        </div><span class="peity-pie" data-peity='{ "fill": ["rgba(255, 255, 255, 0.8)", "rgba(255, 255, 255, 0.2)"]}' data-width="54" data-height="54">5/8</span></div>
                                </div>
                                <div class="ml-3 mr-3">
                                ...
                                <div class="p-3 mini-stats-content">
                                    <div class="mb-4">
                                        <div class="float-right text-right"><span class="badge badge-light text-danger mt-2 mb-2">- 27%</span>
                                            <p class="text-white-50">From previous period</p>
                                        </div><span class="peity-donut" data-peity='{ "fill": ["rgba(255, 255, 255, 0.8)", "rgba(255, 255, 255, 0.2)"], "innerRadius": 18, "radius": 32 }' data-width="54" data-height="54">2/5</span></div>
                                </div>
                                <div class="ml-3 mr-3">
                                    <div class="bg-white p-3 mini-stats-desc rounded">
                                ...
                                <div class="p-3 mini-stats-content">
                                    <div class="mb-4">
                                        <div class="float-right text-right"><span class="badge badge-light text-primary mt-2 mb-2">0%</span>
                                            <p class="text-white-50">From previous period</p>
                                        </div><span class="peity-pie" data-peity='{ "fill": ["rgba(255, 255, 255, 0.8)", "rgba(255, 255, 255, 0.2)"]}' data-width="54" data-height="54">3/8</span></div>
                                </div>
                                <div class="ml-3 mr-3">
                                    <div class="bg-white p-3 mini-stats-desc rounded">
                                ...
                                <div class="p-3 mini-stats-content">
                                    <div class="mb-4">
                                        <div class="float-right text-right"><span class="badge badge-light text-info mt-2 mb-2">- 89%</span>
                                            <p class="text-white-50">From previous period</p>
                                        </div><span class="peity-donut" data-peity='{ "fill": ["rgba(255, 255, 255, 0.8)", "rgba(255, 255, 255, 0.2)"], "innerRadius": 18, "radius": 32 }' data-width="54" data-height="54">3/5</span></div>
                                </div>
                                <div class="ml-3 mr-3">
                                    <div class="bg-white p-3 mini-stats-desc rounded">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="py-4"><span class="peity-line" data-width="100%" data-peity='{ "fill": ["rgba( 228, 60, 51, 0.3)"],"stroke": ["rgba( 228, 60, 51, 0.8)"]}' data-height="60">4,6,8,7,6,7,9,8,6,5,7,5,8,6,4,8,9,8,5,4</span></div>
                                    <div class="row">
                                        <div class="col-6">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row align-items-center mb-4">
                                        <div class="col-6">
                                            ...
                                            <h4><sup class="mr-1"><small>$</small></sup>14,352</h4></div>
                                        <div class="col-6">
                                            <div class="text-center"><span class="peity-pie" data-peity='{ "fill": ["#e2595f", "#f2f2f2"]}' data-width="60" data-height="60">70/100</span></div>
                                        </div>
                                    </div>
                                    <div>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card messages">
                                <div class="card-body">
                                    ...
                                    <nav class="mt-4">
                                        <div class="nav nav-tabs latest-messages-tabs nav-justified" id="nav-tab" role="tablist"><a class="nav-item nav-link active" id="nav-first-tab" data-toggle="tab" href="#nav-first" role="tab" aria-controls="nav-first" aria-selected="true"><h4 class="mt-0">12</h4><p class="text-muted mb-0">November</p></a><a class="nav-item nav-link" id="nav-second-tab" data-toggle="tab" href="#nav-second" role="tab" aria-controls="nav-second" aria-selected="false"><h4 class="mt-0">13</h4><p class="text-muted mb-0">November</p></a></div>
                                    </nav>
                                                ...
                                                <ul class="list-unstyled latest-message-list mb-0">
                                                    <li class="message-list-item">
                                                        <a href="#" class="text-dark">
                                                            <div class="media"><img class="mr-3 thumb-md rounded-circle" src="<?= $this->Url->build('/') ?>/images/users/avatar-2.jpg" alt="">
                                                    ...
                                                    <li class="message-list-item">
                                                        <a href="#" class="text-dark">
                                                            <div class="media"><img class="mr-3 thumb-md rounded-circle" src="<?= $this->Url->build('/') ?>/images/users/avatar-3.jpg" alt="">
                                                                <div class="media-body">
                                                    ...
                                                    <li class="message-list-item">
                                                        <a href="#" class="text-dark">
                                                            <div class="media"><img class="mr-3 thumb-md rounded-circle" src="<?= $this->Url->build('/') ?>/images/users/avatar-4.jpg" alt="">
                                                                <div class="media-body">
                                                    ...
                                                    <li class="message-list-item">
                                                        <a href="#" class="text-dark">
                                                            <div class="media"><img class="mr-3 thumb-md rounded-circle" src="<?= $this->Url->build('/') ?>/images/users/avatar-5.jpg" alt="">
                                                                <div class="media-body">
                                                                    <h6 class="mt-0">Danny Benson</h6>
                                        ...
                                        <div class="tab-pane" id="nav-second" role="tabpanel" aria-labelledby="nav-second-tab">
                                            <div class="p-2 mt-2">
                                                <ul class="list-unstyled latest-message-list mb-0">
                                                    ...
                                                    <li class="message-list-item">
                                                        <a href="#" class="text-dark">
                                                            <div class="media"><img class="mr-3 thumb-md rounded-circle" src="<?= $this->Url->build('/') ?>/images/users/avatar-6.jpg" alt="">
                                                                <div class="media-body">
                                                                    <h6 class="mt-0">Danny Benson</h6>
                                                                    <p class="text-muted mb-0">I've finished it! See you so...</p>
                                                    ...
                                                    <li class="message-list-item">
                                                        <a href="#" class="text-dark">
                                                            <div class="media"><img class="mr-3 thumb-md rounded-circle" src="<?= $this->Url->build('/') ?>/images/users/avatar-7.jpg" alt="">
                                                                <div class="media-body">
                                        ...
                                        <ul class="list-unstyled rec-acti-list mb-0">
                                            <li class="rec-acti-list-item">
                                                <div>
                                                    ...
                                                    <div class="delete-icon"><a href="#" class="text-primary"><i class="mdi mdi-delete-forever h4"></i></a></div>
                                                </div>
                                            </li>
                                            <li class="rec-acti-list-item">
                                                <div>
                                        ...
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div><img src="<?= $this->Url->build('/') ?>/images/users/avatar-2.jpg" alt="" class="thumb-sm rounded-circle mr-2"> Rafael Reardon</div>
                                                    </td>
                                                    <td>14/10/2018</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div><img src="<?= $this->Url->build('/') ?>/images/users/avatar-3.jpg" alt="" class="thumb-sm rounded-circle mr-2"> Thomas Hirsch</div>
                                                    </td>
                                                    <td>15/10/2018</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div><img src="<?= $this->Url->build('/') ?>/images/users/avatar-4.jpg" alt="" class="thumb-sm rounded-circle mr-2"> Archer Desaillly</div>
                                                    </td>
                                                    <td>15/10/2018</td>
                                                    <td><span class="badge badge-success">Delivered</span></td>
                                                    <td>$86</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div><img src="<?= $this->Url->build('/') ?>/images/users/avatar-5.jpg" alt="" class="thumb-sm rounded-circle mr-2"> Michael Flannery</div>
                                                    </td>
                                                    <td>16/10/2018</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div><img src="<?= $this->Url->build('/') ?>/images/users/avatar-6.jpg" alt="" class="thumb-sm rounded-circle mr-2"> Jamie Fishbourne</div>
                                                    </td>
                                                    <td>17/10/2018</td>
                                                    <td><span class="badge badge-success">Delivered</span></td>
                                                    <td>$84</td>
