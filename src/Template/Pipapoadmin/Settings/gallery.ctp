                            ...
                            <div class="page-title-box">
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        ...
                                        <h4 class="page-title mb-0">Gallery settings</h4>
                                ...
                                <div class="card-body">
                                 ...
                                 <?= $this->Form->create('',['id'=>'title_form','enctype'=>'multipart/form-data']) ?>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="title" value="<?php if(!empty($SettingGallery->title))
                                            { echo $SettingGallery->title; } ?>" id="site_title">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="subtitle" class="col-sm-2 col-form-label">Subtitle</label>
                                        <div class="col-sm-4">
                                            <input class="form-control" type="text" name="subtitle" value="<?php if(!empty($SettingGallery->subtitle))
                                            { echo $SettingGallery->subtitle; } ?>" id="subtitle">
                                        </div>
<!--
                                    </div>
                                    <div class="form-group row">
-->
                                        <label for="number_of_images" class="col-sm-3 col-form-label">Number of Image to show</label>
                                        <div class="col-sm-3">
                                            <input class="form-control" type="tel" name="number_of_images" value="<?php if(!empty($SettingGallery->number_of_images))
                                            { echo $SettingGallery->number_of_images; } ?>" id="number_of_images">
                                        </div>
                                    </div>
                                    <div class="form-group row">
